...
module.exports = function getTwitterResolution (message) {
  if (message.includes('Invalid or expired token')) {
    return 'This error means that either the authorization with this app expired or the app was removed from this Twitter account by a managing user on Twitter. You\'ll need to reauthorize your Twitter account before you can continue to publish.';
  }
  ...
  if (message.includes('To protect our users from spam and other malicious activity, this account is temporarily locked')) {
    return 'Twitter has locked your account. This typically means that the account published too many tweets too quickly or too many tweets with the same content. Regardless of the reason, you\'ll need to log in to twitter.com and follow the verification prompts to unlock your account before you can publish again.';
  }
