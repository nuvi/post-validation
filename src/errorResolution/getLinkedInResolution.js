...
module.exports = function getLinkedInResolution (message) {
  if (message.includes('The token used in the request has been revoked by the user')) {
    return 'A user revoked access for this app in LinkedIn. You\'ll need to reauthorize your LinkedIn account before you can continue to publish.';
  }
